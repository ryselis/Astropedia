...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
  ...
  <xsl:template name="createTreeModelFileName">
    <xsl:param name="element" select="."/>
    ...
    <xsl:value-of select="concat($rootFileName, &apos;-tree.json&apos;)"/>
  </xsl:template>

  <xsl:template name="createIconsCSSFileName">
    <xsl:param name="element" select="."/>
    ...
    <xsl:value-of select="concat($rootFileName, &apos;-icons.css&apos;)"/>
  </xsl:template>
  ...
  <xsl:template name="createAllDiagramsFileName">
    <xsl:param name="element" select="."/>
    ...
    <xsl:value-of select="concat($rootFileName, &apos;-alldiagrams-frame.html&apos;)"/>
  </xsl:template>
