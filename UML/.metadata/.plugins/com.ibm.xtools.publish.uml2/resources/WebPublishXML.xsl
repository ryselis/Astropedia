...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:output encoding="UTF-8" method="xml" indent="yes" omit-xml-declaration="yes" doctype-public="-//W3C//DTD XHTML 1.0 Transitional//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"/>
        ...
        <xsl:if test="$isTopLevelElement = 'true()'">
            ...
            <xsl:choose>
                <xsl:when test="$navigation_layout != 'NAVI_DOJO'">
                    ...
                    <!-- Create the navigation page for the lower left hand all elements navigation frame page
                    ...
                    <!-- Create the navigation page for the lower left hand all diagrams navigation frame page
                        GenerateAllDiagramsList.xsl-->
                    <xsl:apply-templates
                        select="$nodesetEntryElements" mode="SplitMode_AllDiagramsNavigationHtml">
                        <xsl:with-param name="titlePattern" select="$titlePattern"/>
                    </xsl:apply-templates>
    ...
    <xsl:include href="GenerateAllDiagramsList.xsl"/>
    ...
    <xsl:include href="uml2content/ActivityPartitionContent.xsl"/> 
    <xsl:include href="uml2content/ReceptionContent.xsl"/> 
    <xsl:include href="uml2content/EnumerationLiteralContent.xsl"/> 
    <xsl:include href="uml2content/SlotContent.xsl"/> 
    <xsl:include href="uml2content/ValueSpecificationContent.xsl"/> 
