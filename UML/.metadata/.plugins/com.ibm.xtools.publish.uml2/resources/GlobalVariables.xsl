...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- this key holds fast access to all enumeration attributes in the model by their 'xmi:id' attribute -->
    <xsl:key name="EnumerationAttributesByIds" match="packagedElement[@xsi:type='uml:Enumeration']/ownedAttribute" use="@xmi:id"/>
    ...
    <xsl:variable name="slotsAndValuesTableTitle">
        <xsl:call-template name="getLocalizedString">
            <xsl:with-param name="key" select="'TableHeading.SlotsAndValues'"/>
        </xsl:call-template>
    </xsl:variable>
    ...
    <xsl:variable name="slotsAndValuesNavName">
        <xsl:call-template name="getLocalizedString">
            <xsl:with-param name="key" select="'Nav.SlotsAndValues'"/>
        </xsl:call-template>
    </xsl:variable>
    ...
    <xsl:variable name="nestedNodesNavName">
        <xsl:call-template name="getLocalizedString">
            <xsl:with-param name="key" select="'Nav.NestedNodes'"/>
        </xsl:call-template>
    </xsl:variable>
    ...
    <xsl:variable name="packagedElementsNavName">
        <xsl:call-template name="getLocalizedString">
            <xsl:with-param name="key" select="'Nav.PackagedElements'"/>
        </xsl:call-template>
    </xsl:variable>
    ...
    <xsl:variable 
            name="globalTopLevelAllSupportedElementTypes" select="
                            ...
                            //ownedDiagrams[@xsi:type='notation:Diagram'] |
                            ...
                            //nestedNode[@xsi:type='uml:Node'] |
                            //nestedNode[@xsi:type='uml:Device'] | 
                            //nestedNode[@xsi:type='uml:ExecutionEnvironment'] | 
                            //realization[@xsi:type='uml:Realization'] |
                            //packagedElement[@xsi:type='uml:Realization'] |
                            ...
                            //packagedElement[@xsi:type='uml:InformationFlow'] |
                            ...
                            //packagedElement[@xsi:type='uml:SendSignalEvent'] |
                            //packagedElement[@xsi:type='uml:ReceiveOperationEvent'] |
                            //packagedElement[@xsi:type='uml:ReceiveSignalEvent'] |
                            //packagedElement[@xsi:type='uml:AnyReceiveEvent'] |
                            //packagedElement[@xsi:type='uml:CallEvent'] |
                            //packagedElement[@xsi:type='uml:ExecutionEvent'] |
                            //packagedElement[@xsi:type='uml:ChangeEvent'] |
                            //packagedElement[@xsi:type='uml:SignalEvent'] |
                            //packagedElement[@xsi:type='uml:CreationEvent'] |
                            //packagedElement[@xsi:type='uml:DestructionEvent'] |
                            //packagedElement[@xsi:type='uml:TimeEvent'] |
                            //extensionPoint[@xsi:type='uml:ExtensionPoint'] |
                            //trigger[@xsi:type='uml:Trigger'] |
                            ...
                            //ownedBehavior[@xsi:type='uml:StateMachine'] |
                            ...
                            //nestedClassifier[@xsi:type='uml:Activity'] | 
                            ...
                            //fragment[@xsi:type='uml:StateInvariant'] |
                            //ownedParameteredElement[@xsi:type='uml:Class'] |
                            //group[@xsi:type='uml:ActivityPartition'] |
                            //subpartition[@xsi:type='uml:ActivityPartition'] |
                            //ownedReception[@xsi:type='uml:Reception'] |
                            //ownedLiteral[@xsi:type='uml:EnumerationLiteral'] |
                            //slot[@xsi:type='uml:Slot'] |
                            //value">
    </xsl:variable>
