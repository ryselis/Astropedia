...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for 'group' <tag>  -->
    <!-- ======================================================================================== -->
    <xsl:template name="createGroupContent" match="group[@xsi:type='uml:ActivityPartition'] | subpartition[@xsi:type='uml:ActivityPartition']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.ActivityPartition'"> </xsl:with-param>
        ...
        <!-- for future steps unique to UML ActivityPartition -->
    </xsl:template>
</xsl:stylesheet>
