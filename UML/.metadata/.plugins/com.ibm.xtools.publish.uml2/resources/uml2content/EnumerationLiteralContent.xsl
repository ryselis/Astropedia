...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <!-- Create content for 'ownedLiteral' <tag>  -->
    <!-- ======================================================================================== -->
    <xsl:template name="createEnumerationLiteralContent" match="ownedLiteral[@xsi:type='uml:EnumerationLiteral']" mode="createElementContent">
        ...
        <xsl:apply-templates  select="." mode="NamedElement">
            <xsl:with-param name="titleKey" select="'Heading.EnumerationLiteral'"> </xsl:with-param>
        ...
        <!-- for future steps unique to UML EnumerationLiteral -->
    </xsl:template>
</xsl:stylesheet>
