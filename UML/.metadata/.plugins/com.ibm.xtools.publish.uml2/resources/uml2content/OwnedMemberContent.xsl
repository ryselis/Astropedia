...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <!-- ======================================================================================== -->
    <xsl:template name="createOwnedMemberContent" match="packagedElement | nestedNode | realization | interfaceRealization | extensionPoint | effect" mode="createElementContent">
        ...
        <xsl:choose>
            ...
            <xsl:when test="(@xsi:type='uml:SendOperationEvent') or 
                            (@xsi:type='uml:SendSignalEvent') or 
                            (@xsi:type='uml:ReceiveOperationEvent') or 
                            (@xsi:type='uml:ReceiveSignalEvent') or 
                            (@xsi:type='uml:AnyReceiveEvent') or
                            (@xsi:type='uml:CallEvent') or
                            (@xsi:type='uml:ExecutionEvent') or
                            (@xsi:type='uml:ChangeEvent') or
                            (@xsi:type='uml:SignalEvent') or
                            (@xsi:type='uml:CreationEvent') or
                            (@xsi:type='uml:DestructionEvent') or
							(@xsi:type='uml:TimeEvent')">
                <xsl:apply-templates select="." mode="NamedElement">
            ...
            <xsl:when test="(@xsi:type='uml:OpaqueBehavior')">
                <xsl:apply-templates select="." mode="NamedElement">
                    <xsl:with-param name="titlePattern" select="$titlePattern"/>
                    <xsl:with-param name="descriptionPattern" select="$descriptionPattern"/>
                    <xsl:with-param name="keywordsWithPatterns" select="$keywordsWithPatterns"/>
            ...
            <xsl:when test="@xsi:type='uml:InformationFlow'">
                <xsl:apply-templates select="." mode="NamedElement">
                    <xsl:with-param name="titlePattern" select="$titlePattern"/>
                    <xsl:with-param name="descriptionPattern" select="$descriptionPattern"/>
                    <xsl:with-param name="keywordsWithPatterns" select="$keywordsWithPatterns"/>
